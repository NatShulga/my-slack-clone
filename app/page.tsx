...
export default function ChatPage() {
  ...
  const [messages, setMessages] = useState([{ id: 1, user: 'Alex', text: 'Hello world!', time: '10:15', isMine: false},
  ...
  return (
    <div className="flex h-screen bg-[#1a1b1e] text-white font-sans">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <form onSubmit={sendMessage} className="p-4 border-t border-[#333538] bg-[#1f2024]">
          <input
            type="text"
